...
REM Set Ganache to expose through WLS2 interface IP like 172.23.64.1 and use that IP address
REM set ethnet_ip="172.23.64.1"
set ethnet_ip="127.0.0.1"
REM Ganache uses port 7545, other networks uses 8545
set ethnet_port="7545"
REM export ethnet_port="8545"
